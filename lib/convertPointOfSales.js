 ...
 ************************************************************************************/
 ...
 const convertUtils = {
  ...
  convertAvailableTenderType(availableTenderType) {
    if(availableTenderType) {
      const { getDecimalFromGRPC } = require('./convertBaseDataType.js');
      return {
        id: availableTenderType.getId(),
        uuid: availableTenderType.getUuid(),
        key: availableTenderType.getKey(),
        name: availableTenderType.getName(),
        is_pos_required_pin: availableTenderType.getIsPosRequiredPin(),
        is_allowed_to_refund: availableTenderType.getIsAllowedToRefund(),
        maximum_refund_allowed: getDecimalFromGRPC(
          availableTenderType.getMaximumRefundAllowed()
        ),
        maximum_daily_refund_allowed: getDecimalFromGRPC(
