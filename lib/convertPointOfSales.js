...
const convertUtils = {
  ...
  convertCashMovements(movement) {
    const { convertCurrencyFromGRPC, convertChargeFromGRPC, convertSalesRepresentativeFromGRPC, convertPaymentMethodFromGRPC, convertDocumentTypeFromGRPC } = require('./convertCoreFunctionality.js');
