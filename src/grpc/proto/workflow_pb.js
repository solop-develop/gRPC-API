...
goog.exportSymbol('proto.workflow.WorkflowCondition.ConditionType', null, global);
goog.exportSymbol('proto.workflow.WorkflowCondition.Operation', null, global);
goog.exportSymbol('proto.workflow.WorkflowDefinition', null, global);
goog.exportSymbol('proto.workflow.WorkflowDefinition.DurationUnit', null, global);
goog.exportSymbol('proto.workflow.WorkflowDefinition.PublishStatus', null, global);
...
goog.exportSymbol('proto.workflow.WorkflowEvent.EventType', null, global);
goog.exportSymbol('proto.workflow.WorkflowEvent.WorkflowState', null, global);
goog.exportSymbol('proto.workflow.WorkflowNode', null, global);
goog.exportSymbol('proto.workflow.WorkflowNode.Action', null, global);
goog.exportSymbol('proto.workflow.WorkflowProcess', null, global);
goog.exportSymbol('proto.workflow.WorkflowProcess.Priority', null, global);
goog.exportSymbol('proto.workflow.WorkflowProcess.WorkflowState', null, global);
...
proto.workflow.WorkflowDefinition.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 14:
      ...
      break;
    case 15:
      var value = /** @type {!proto.workflow.WorkflowDefinition.PublishStatus} */ (reader.readEnum());
      msg.setPublishStatus(value);
      break;
    case 16:
      var value = /** @type {!proto.workflow.WorkflowDefinition.DurationUnit} */ (reader.readEnum());
 ...
 * @enum {number}
 */
proto.workflow.WorkflowDefinition.DurationUnit = {
  DAY: 0,
  HOUR: 1,
  MINUTE: 2,
  MONTH: 3,
 ...
 * @enum {number}
 */
proto.workflow.WorkflowDefinition.PublishStatus = {
  RELEASED: 0,
  TEST: 1,
  UNDER_REVISION: 2,
  VOID: 3
 ...
 * @return {!proto.workflow.WorkflowDefinition.PublishStatus}
 */
proto.workflow.WorkflowDefinition.prototype.getPublishStatus = function() {
  return /** @type {!proto.workflow.WorkflowDefinition.PublishStatus} */ (jspb.Message.getFieldWithDefault(this, 15, 0));
};


/**
 * @param {!proto.workflow.WorkflowDefinition.PublishStatus} value
 * @return {!proto.workflow.WorkflowDefinition} returns this
 */
 ...
 * @return {!proto.workflow.WorkflowDefinition.DurationUnit}
 */
proto.workflow.WorkflowDefinition.prototype.getDurationUnit = function() {
  return /** @type {!proto.workflow.WorkflowDefinition.DurationUnit} */ (jspb.Message.getFieldWithDefault(this, 16, 0));
};


/**
 * @param {!proto.workflow.WorkflowDefinition.DurationUnit} value
 * @return {!proto.workflow.WorkflowDefinition} returns this
 */
...
proto.workflow.WorkflowNode.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 12:
      ...
      break;
    case 13:
      var value = /** @type {!proto.workflow.WorkflowNode.Action} */ (reader.readEnum());
      msg.setAction(value);
      break;
    case 14:
 ...
 * @enum {number}
 */
proto.workflow.WorkflowNode.Action = {
  USER_CHOICE: 0,
  DOCUMENT_ACTION: 1,
  SUB_WORKFLOW: 2,
  EMAIL: 3,
 ...
 * @return {!proto.workflow.WorkflowNode.Action}
 */
proto.workflow.WorkflowNode.prototype.getAction = function() {
  return /** @type {!proto.workflow.WorkflowNode.Action} */ (jspb.Message.getFieldWithDefault(this, 13, 0));
};


/**
 * @param {!proto.workflow.WorkflowNode.Action} value
 * @return {!proto.workflow.WorkflowNode} returns this
 */
...
proto.workflow.WorkflowCondition.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 5:
      ...
      break;
    case 6:
      var value = /** @type {!proto.workflow.WorkflowCondition.ConditionType} */ (reader.readEnum());
      msg.setConditionType(value);
      break;
    case 7:
      var value = /** @type {!proto.workflow.WorkflowCondition.Operation} */ (reader.readEnum());
 ...
 * @enum {number}
 */
proto.workflow.WorkflowCondition.ConditionType = {
  AND: 0,
  OR: 1
};
 ...
 * @enum {number}
 */
proto.workflow.WorkflowCondition.Operation = {
  EQUAL: 0,
  NOT_EQUAL: 1,
  LIKE: 2,
  GREATER: 4,
 ...
 * @return {!proto.workflow.WorkflowCondition.ConditionType}
 */
proto.workflow.WorkflowCondition.prototype.getConditionType = function() {
  return /** @type {!proto.workflow.WorkflowCondition.ConditionType} */ (jspb.Message.getFieldWithDefault(this, 6, 0));
};


/**
 * @param {!proto.workflow.WorkflowCondition.ConditionType} value
 * @return {!proto.workflow.WorkflowCondition} returns this
 */
 ...
 * @return {!proto.workflow.WorkflowCondition.Operation}
 */
proto.workflow.WorkflowCondition.prototype.getOperation = function() {
  return /** @type {!proto.workflow.WorkflowCondition.Operation} */ (jspb.Message.getFieldWithDefault(this, 7, 0));
};


/**
 * @param {!proto.workflow.WorkflowCondition.Operation} value
 * @return {!proto.workflow.WorkflowCondition} returns this
 */
...
proto.workflow.WorkflowActivity.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    priority: jspb.Message.getFieldWithDefault(msg, 12, 0),
    created: jspb.Message.getFieldWithDefault(msg, 13, 0),
    lastAlert: jspb.Message.getFieldWithDefault(msg, 14, 0),
...
/**
 * optional WorkflowProcess workflow_process = 15;
...
proto.workflow.WorkflowActivity.prototype.getWorkflowProcess = function() {
  return /** @type{?proto.workflow.WorkflowProcess} */ (
    jspb.Message.getWrapperField(this, proto.workflow.WorkflowProcess, 15));
};
...
/**
 * optional WorkflowDefinition workflow = 16;
 * @return {?proto.workflow.WorkflowDefinition}
 */
proto.workflow.WorkflowActivity.prototype.getWorkflow = function() {
  return /** @type{?proto.workflow.WorkflowDefinition} */ (
    jspb.Message.getWrapperField(this, proto.workflow.WorkflowDefinition, 16));
};
...
proto.workflow.WorkflowProcess.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 13:
      ...
      break;
    case 14:
      var value = /** @type {!proto.workflow.WorkflowProcess.WorkflowState} */ (reader.readEnum());
      msg.setWorkflowState(value);
      break;
    case 15:
      var value = /** @type {!proto.workflow.WorkflowProcess.Priority} */ (reader.readEnum());
      msg.setPriority(value);
      break;
    case 16:
 ...
 * @enum {number}
 */
proto.workflow.WorkflowProcess.WorkflowState = {
  RUNNING: 0,
  COMPLETED: 1,
  ABORTED: 2,
  TERMINATED: 3,
 ...
 * @enum {number}
 */
proto.workflow.WorkflowProcess.Priority = {
  URGENT: 0,
  HIGH: 1,
  MEDIUM: 2,
  LOW: 3,
 ...
 * @return {!proto.workflow.WorkflowProcess.WorkflowState}
 */
proto.workflow.WorkflowProcess.prototype.getWorkflowState = function() {
  return /** @type {!proto.workflow.WorkflowProcess.WorkflowState} */ (jspb.Message.getFieldWithDefault(this, 14, 0));
};


/**
 * @param {!proto.workflow.WorkflowProcess.WorkflowState} value
 * @return {!proto.workflow.WorkflowProcess} returns this
 */
 ...
 * @return {!proto.workflow.WorkflowProcess.Priority}
 */
proto.workflow.WorkflowProcess.prototype.getPriority = function() {
  return /** @type {!proto.workflow.WorkflowProcess.Priority} */ (jspb.Message.getFieldWithDefault(this, 15, 0));
};


/**
 * @param {!proto.workflow.WorkflowProcess.Priority} value
 * @return {!proto.workflow.WorkflowProcess} returns this
 */
...
proto.workflow.WorkflowEvent.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 15:
      ...
      break;
    case 16:
      var value = /** @type {!proto.workflow.WorkflowEvent.WorkflowState} */ (reader.readEnum());
      msg.setWorkflowState(value);
      break;
    case 17:
      var value = /** @type {!proto.workflow.WorkflowEvent.EventType} */ (reader.readEnum());
 ...
 * @enum {number}
 */
proto.workflow.WorkflowEvent.WorkflowState = {
  RUNNING: 0,
  COMPLETED: 1,
  ABORTED: 2,
  TERMINATED: 3,
 ...
 * @enum {number}
 */
proto.workflow.WorkflowEvent.EventType = {
  PROCESS_CREATED: 0,
  PROCESS_COMPLETED: 1,
  STATE_CHANGED: 2
};
 ...
 * @return {!proto.workflow.WorkflowEvent.WorkflowState}
 */
proto.workflow.WorkflowEvent.prototype.getWorkflowState = function() {
  return /** @type {!proto.workflow.WorkflowEvent.WorkflowState} */ (jspb.Message.getFieldWithDefault(this, 16, 0));
};


/**
 * @param {!proto.workflow.WorkflowEvent.WorkflowState} value
 * @return {!proto.workflow.WorkflowEvent} returns this
 */
 ...
 * @return {!proto.workflow.WorkflowEvent.EventType}
 */
proto.workflow.WorkflowEvent.prototype.getEventType = function() {
  return /** @type {!proto.workflow.WorkflowEvent.EventType} */ (jspb.Message.getFieldWithDefault(this, 17, 0));
};


/**
 * @param {!proto.workflow.WorkflowEvent.EventType} value
 * @return {!proto.workflow.WorkflowEvent} returns this
 */
