...
goog.exportSymbol('proto.payment_allocation.CalculateDifferenceRequest', null, global);
goog.exportSymbol('proto.payment_allocation.CalculateDifferenceResponse', null, global);
 ...
 * @constructor
 */
proto.payment_allocation.CalculateDifferenceRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.payment_allocation.CalculateDifferenceRequest.repeatedFields_, null);
};
goog.inherits(proto.payment_allocation.CalculateDifferenceRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.payment_allocation.CalculateDifferenceRequest.displayName = 'proto.payment_allocation.CalculateDifferenceRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.payment_allocation.CalculateDifferenceResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.payment_allocation.CalculateDifferenceResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.payment_allocation.CalculateDifferenceResponse.displayName = 'proto.payment_allocation.CalculateDifferenceResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.payment_allocation.CalculateDifferenceRequest.repeatedFields_ = [1,2];
 ...
 * @return {!Object}
 */
proto.payment_allocation.CalculateDifferenceRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.payment_allocation.CalculateDifferenceRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.payment_allocation.CalculateDifferenceRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.payment_allocation.CalculateDifferenceRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.payment_allocation.CalculateDifferenceRequest}
 */
proto.payment_allocation.CalculateDifferenceRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.payment_allocation.CalculateDifferenceRequest;
  return proto.payment_allocation.CalculateDifferenceRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.payment_allocation.CalculateDifferenceRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.payment_allocation.CalculateDifferenceRequest}
 */
proto.payment_allocation.CalculateDifferenceRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.payment_allocation.CalculateDifferenceRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.payment_allocation.CalculateDifferenceRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.payment_allocation.CalculateDifferenceRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.payment_allocation.CalculateDifferenceRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
...
/**
 * repeated data.KeyValueSelection payments = 1;
 * @return {!Array<!proto.data.KeyValueSelection>}
 */
proto.payment_allocation.CalculateDifferenceRequest.prototype.getPaymentsList = function() {
  return /** @type{!Array<!proto.data.KeyValueSelection>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto_base_data_type_pb.KeyValueSelection, 1));
};


/**
 * @param {!Array<!proto.data.KeyValueSelection>} value
 * @return {!proto.payment_allocation.CalculateDifferenceRequest} returns this
*/
proto.payment_allocation.CalculateDifferenceRequest.prototype.setPaymentsList = function(value) {
 ...
 */
proto.payment_allocation.CalculateDifferenceRequest.prototype.addPayments = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.data.KeyValueSelection, opt_index);
};
 ...
 * @return {!proto.payment_allocation.CalculateDifferenceRequest} returns this
 */
proto.payment_allocation.CalculateDifferenceRequest.prototype.clearPaymentsList = function() {
  return this.setPaymentsList([]);
};


/**
 * repeated data.KeyValueSelection invoices = 2;
 * @return {!Array<!proto.data.KeyValueSelection>}
 */
proto.payment_allocation.CalculateDifferenceRequest.prototype.getInvoicesList = function() {
  return /** @type{!Array<!proto.data.KeyValueSelection>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto_base_data_type_pb.KeyValueSelection, 2));
};
 ...
 * @return {!proto.payment_allocation.CalculateDifferenceRequest} returns this
*/
proto.payment_allocation.CalculateDifferenceRequest.prototype.setInvoicesList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 2, value);
};
 ...
 * @return {!proto.data.KeyValueSelection}
 */
proto.payment_allocation.CalculateDifferenceRequest.prototype.addInvoices = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.data.KeyValueSelection, opt_index);
};
 ...
 * @return {!proto.payment_allocation.CalculateDifferenceRequest} returns this
 */
proto.payment_allocation.CalculateDifferenceRequest.prototype.clearInvoicesList = function() {
 ...
 * @return {!Object}
 */
proto.payment_allocation.CalculateDifferenceResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.payment_allocation.CalculateDifferenceResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.payment_allocation.CalculateDifferenceResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.payment_allocation.CalculateDifferenceResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    difference: (f = msg.getDifference()) && proto_base_data_type_pb.Decimal.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.payment_allocation.CalculateDifferenceResponse}
 */
proto.payment_allocation.CalculateDifferenceResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.payment_allocation.CalculateDifferenceResponse;
  return proto.payment_allocation.CalculateDifferenceResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.payment_allocation.CalculateDifferenceResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.payment_allocation.CalculateDifferenceResponse}
 */
proto.payment_allocation.CalculateDifferenceResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.payment_allocation.CalculateDifferenceResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.payment_allocation.CalculateDifferenceResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.payment_allocation.CalculateDifferenceResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.payment_allocation.CalculateDifferenceResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
...
/**
 * optional data.Decimal difference = 1;
 * @return {?proto.data.Decimal}
 */
proto.payment_allocation.CalculateDifferenceResponse.prototype.getDifference = function() {
  return /** @type{?proto.data.Decimal} */ (
...
/**
 * @param {?proto.data.Decimal|undefined} value
 * @return {!proto.payment_allocation.CalculateDifferenceResponse} returns this
*/
proto.payment_allocation.CalculateDifferenceResponse.prototype.setDifference = function(value) {
 ...
 * @return {!proto.payment_allocation.CalculateDifferenceResponse} returns this
 */
proto.payment_allocation.CalculateDifferenceResponse.prototype.clearDifference = function() {
 ...
 * @return {boolean}
 */
proto.payment_allocation.CalculateDifferenceResponse.prototype.hasDifference = function() {
...
/**
 * repeated data.KeyValueSelection payments = 11;
 * @return {!Array<!proto.data.KeyValueSelection>}
 */
proto.payment_allocation.ProcessRequest.prototype.getPaymentsList = function() {
  return /** @type{!Array<!proto.data.KeyValueSelection>} */ (
 ...
 * @return {!proto.payment_allocation.ProcessRequest} returns this
*/
proto.payment_allocation.ProcessRequest.prototype.setPaymentsList = function(value) {
 ...
 * @return {!proto.data.KeyValueSelection}
 */
proto.payment_allocation.ProcessRequest.prototype.addPayments = function(opt_value, opt_index) {
 ...
 * @return {!proto.payment_allocation.ProcessRequest} returns this
 */
proto.payment_allocation.ProcessRequest.prototype.clearPaymentsList = function() {
  return this.setPaymentsList([]);
};


/**
 * repeated data.KeyValueSelection invoices = 12;
 * @return {!Array<!proto.data.KeyValueSelection>}
 */
proto.payment_allocation.ProcessRequest.prototype.getInvoicesList = function() {
  return /** @type{!Array<!proto.data.KeyValueSelection>} */ (
 ...
 * @return {!proto.payment_allocation.ProcessRequest} returns this
*/
proto.payment_allocation.ProcessRequest.prototype.setInvoicesList = function(value) {
 ...
 * @return {!proto.data.KeyValueSelection}
 */
proto.payment_allocation.ProcessRequest.prototype.addInvoices = function(opt_value, opt_index) {
 ...
 * @return {!proto.payment_allocation.ProcessRequest} returns this
 */
proto.payment_allocation.ProcessRequest.prototype.clearInvoicesList = function() {
  return this.setInvoicesList([]);
};
