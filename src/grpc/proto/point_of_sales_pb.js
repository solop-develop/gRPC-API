...
proto.data.ListAvailableWarehousesResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto_base_data_type_pb.ListValue.toObject, includeInstance),
...
proto.data.ListAvailableWarehousesResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto_base_data_type_pb.ListValue;
      reader.readMessage(value,proto_base_data_type_pb.ListValue.deserializeBinaryFromReader);
...
proto.data.ListAvailableWarehousesResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto_base_data_type_pb.ListValue.serializeBinaryToWriter
    );
  }
 ...
 * @return {!Array<!proto.data.ListValue>}
 */
proto.data.ListAvailableWarehousesResponse.prototype.getWarehousesList = function() {
  return /** @type{!Array<!proto.data.ListValue>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto_base_data_type_pb.ListValue, 2));
};


/**
 * @param {!Array<!proto.data.ListValue>} value
 * @return {!proto.data.ListAvailableWarehousesResponse} returns this
*/
...
/**
 * @param {!proto.data.ListValue=} opt_value
...
proto.data.ListAvailableWarehousesResponse.prototype.addWarehouses = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.data.ListValue, opt_index);
};
