...
goog.exportSymbol('proto.file_management.Status', null, global);
/**
...
proto.file_management.LoadResourceRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    resource: (f = msg.getResource()) && proto.file_management.Resource.toObject(includeInstance, f)
  };
...
proto.file_management.LoadResourceRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      break;
    case 4:
      var value = new proto.file_management.Resource;
      reader.readMessage(value,proto.file_management.Resource.deserializeBinaryFromReader);
...
proto.file_management.LoadResourceRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      4,
      f,
      proto.file_management.Resource.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {string}
 */
proto.file_management.LoadResourceRequest.prototype.getFileName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.file_management.LoadResourceRequest} returns this
 */
proto.file_management.LoadResourceRequest.prototype.setFileName = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @return {?proto.file_management.Resource}
 */
proto.file_management.LoadResourceRequest.prototype.getResource = function() {
  return /** @type{?proto.file_management.Resource} */ (
    jspb.Message.getWrapperField(this, proto.file_management.Resource, 4));
};


/**
 * @param {?proto.file_management.Resource|undefined} value
 * @return {!proto.file_management.LoadResourceRequest} returns this
*/
proto.file_management.LoadResourceRequest.prototype.setResource = function(value) {
 ...
 * @return {!proto.file_management.LoadResourceRequest} returns this
 */
proto.file_management.LoadResourceRequest.prototype.clearResource = function() {
 ...
 * @return {boolean}
 */
proto.file_management.LoadResourceRequest.prototype.hasResource = function() {
