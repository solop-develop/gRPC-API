    ...
    if (productConversionToConvert) {
      ...
      return {
        ...
        multiply_rate: getDecimalFromGRPC(
          productConversionToConvert.getMultiplyRate()
        ),
        divide_rate: getDecimalFromGRPC(
          productConversionToConvert.getDivideRate()
        ),
        uom: convertCoreFunctionality.convertUnitOfMeasureFromGRPC(
          productConversionToConvert.getUom()
        ),
