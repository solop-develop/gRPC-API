...
class Invoice {
  ...
  initInvoiceService() {
    ...
    this.invoice = new services.InvoiceClient(this.businessHost, grpc.credentials.createInsecure());
  }
  ...
  listInvoiceInfo({
    ...
    const { ListInvoiceInfo } = require('../grpc/proto/invoice_grpc_pb');
    ...
    this.getInvoiceService().listInvoiceInfo(request, callback);
  }
