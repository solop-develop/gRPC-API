...
class MatchPORReceiptInvoice 
{
   ...
   */
  stubFile = require('@adempiere/grpc-api/src/grpc/proto/match_po_receipt_invoice_pb.js');
  ...
  initMatchPORReceiptInvoiceService() {
    ...
    const services = require('@adempiere/grpc-api/src/grpc/proto/match_po_receipt_invoice_grpc_pb');
