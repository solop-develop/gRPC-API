...
class ExpressMovement {
   ...
   */
  stubFile = require('@adempiere/grpc-api/src/grpc/proto/express_movement_pb.js');
  ...
  initExpressMovementService() {
    ...
    const services = require('@adempiere/grpc-api/src/grpc/proto/express_movement_grpc_pb.js');
