...
class InOut {
  ...
  initInOutService() {
    ...
    this.inOut = new services.InOutClient(this.businessHost, grpc.credentials.createInsecure());
  }
  ...
  listInOutInfo({
    ...
    const { ListInOutInfo } = require('../grpc/proto/in_out_grpc_pb');
    ...
    this.getInOutService().listInOutInfo(request, callback);
  }
